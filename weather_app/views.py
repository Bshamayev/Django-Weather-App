...
def index(request):
    ...
    if request.method == "POST":
        ...
        weather_data, daily_forecasts = fetch_weather(city, state, country, coordinates_url, weather_url, forecast_url)
...
def fetch_weather(city, state, country, coordinates_url, weather_url, forecast_url):
    coord_response = requests.get(coordinates_url.format(city,state, country, API_KEY)).json()
